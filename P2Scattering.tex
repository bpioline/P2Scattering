...
\defn{IndexFromSequences}{\vardef{LiScattSeq},,\{\vardef{s0},\vardef{t0} \}}{c constructs all possible lists of abelianized constituents from the list of scattering sequences \var{LiScattSeq}, removes duplicates, and applies \fun{IndexFromAbelianizedSequences} on each of them}
